...
INSERT INTO "new_Booking" ("category", "createdAt", "driverAmount", "from", "id", "passengerId", "paymentIntentId", "paymentStatus", "pickupTime", "platformFee", "price", "status", "to", "updatedAt") SELECT "category", "createdAt", "driverAmount", "from", "id", "passengerId", "paymentIntentId", "paymentStatus", "pickupTime", "platformFee", "price", "status", "to", "updatedAt" FROM "Booking";
DROP TABLE "Booking";
