          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-[10px] font-black text-white/35 uppercase tracking-widest">{dp("password")}</label>
                <Link href="/forgot-password" className="text-[10px] text-white/25 hover:text-brand-gold transition-colors">
                  {dp("forgot")}
                </Link>
              </div>
