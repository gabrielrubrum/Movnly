...
function PartnerLoginForm() {
  ...
  const redirect = searchParams.get("redirect") || "/parceiros";
    ...
    try {
      ...
      if (tab === "login") {
        if (data.user?.role !== "PARTNER" && data.user?.role !== "ADMIN") {
          throw new Error("ESTA CONTA NÃO É DE PARCEIRO.");
        }
        ...
        setSuccess("REDE ATIVADA. VERIFIQUE O E-MAIL.");
      ...
      <div className="mb-12 space-y-4">
        <h2 className="text-4xl md:text-5xl font-light text-white tracking-tight leading-[1.1] uppercase font-sans">
          ...
          <span className="text-brand-gold font-medium">
            {tab === "login" ? (requires2FA ? "Adicional." : "Parceiro.") : "Parceiro."}
          </span>
        </h2>
      ...
      <div className="mt-10 flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col gap-3 pt-4 border-t border-white/5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <User className="w-3.5 h-3.5 text-brand-gold flex-shrink-0" />
              <span className="text-[8px] font-bold uppercase tracking-[0.1em] whitespace-nowrap">Cliente</span>
            </Link>
    ...
    <div className="min-h-screen bg-[#020203] flex flex-col lg:flex-row overflow-hidden font-sans">
      <div className="hidden lg:flex lg:w-[45%] relative items-end p-20 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=85&w=1400')` }}
        />
