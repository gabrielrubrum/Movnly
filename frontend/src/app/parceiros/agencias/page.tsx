...
import { Users, Check, ArrowRight, Phone, Shield, Globe } from "lucide-react";
...
export default function AgenciasPage() {
    ...
    const benefitIcons = [Shield, Globe, Users];
    const benefitKeys = ["0", "1", "2"];
    
    const benefits = benefitKeys.map((key, i) => {
        const benefitData = t(`b2b.segments.agencies.benefits.${key}`) as any;
        return {
            ...benefitData,
            icon: benefitIcons[i],
            size: i === 2 ? "large" : "medium",
            image: i === 2 ? "https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg" : undefined
        };
    });
        ...
        <div className="min-h-screen bg-luxury-mesh text-white selection:bg-brand-gold/30">
            ...
            <main className="overflow-hidden">
                    ...
                    <div className="nx-container relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            ...
                            >
                                ...
                                >
                                    <Users className="w-3.5 h-3.5" /> {t("b2b.segments.agencies.badge")}
                                </motion.div>

                                <h1 className="text-6xl md:text-8xl font-bold leading-[1.1] mb-8">
                                    {t("b2b.segments.agencies.subtitle1")}<br />
                                    <span className="font-bold text-brand-gold">{t("b2b.segments.agencies.subtitle2")}</span>
                                </h1>

                                <p className="text-lg md:text-xl text-white/50 mb-12 max-w-xl leading-relaxed font-light">
                                    {t("b2b.segments.agencies.desc")}
                                </p>
                ...
                <section className="nx-container py-32">
                    <div className="mb-24">
                        <span className="text-brand-gold text-[10px] uppercase tracking-[0.5em] font-medium mb-6 block">Travel Agent Network</span>
                        <h2 className="text-5xl md:text-7xl font-bold tracking-tight">
                            {t("b2b.segments.agencies.bento_title").split(" ").slice(0, 2).join(" ")}<br />
                            <span className="text-serif italic font-medium text-white/40">{t("b2b.segments.agencies.bento_desc")}</span>
                        </h2>
                    </div>
                                    ...
                                    <div className="relative z-10 flex-1 flex flex-col justify-center border-t md:border-t-0 md:border-l border-white/10 pt-10 md:pt-0 md:pl-12">
                                        <div className="grid grid-cols-2 gap-8">
                                            <div className="space-y-1">
                                                <p className="text-3xl font-bold text-white tracking-tighter">VIP</p>
                                                <p className="text-[9px] uppercase tracking-[0.3em] text-white/30 font-bold">Priority Support</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-3xl font-bold text-white tracking-tighter">100%</p>
                                                <p className="text-[9px] uppercase tracking-[0.3em] text-white/30 font-bold">Reliability</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
                    ...
                    >
                        ...
                        <div className="space-y-8 max-w-2xl relative z-10">
                            <h2 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
                                {t("b2b.segments.agencies.subtitle2")}<br />
                                <span className="text-serif italic font-medium text-white/40">{t("b2b.segments.agencies.cta_card_desc")}</span>
                            </h2>
                        </div>
