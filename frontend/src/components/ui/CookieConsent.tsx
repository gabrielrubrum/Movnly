...
export function CookieConsent() {
    ...
    useEffect(() => {
        const consent = localStorage.getItem("movnly_cookies_accepted");
        if (!consent) {
            setIsVisible(true);
        }
    }, []);
    ...
    const accept = () => {
        localStorage.setItem("movnly_cookies_accepted", "true");
        setIsVisible(false);
    };

    const decline = () => {
        localStorage.setItem("movnly_cookies_accepted", "false");
        setIsVisible(false);
    };
