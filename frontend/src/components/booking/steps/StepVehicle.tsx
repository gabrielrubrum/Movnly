    ...
    <div className="animate-luxury-reveal min-h-screen pb-40">
      ...
      <div className="mt-20 pt-10 border-t border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-8 font-sans">
          <button onClick={onBack} className="text-[10px] font-black uppercase tracking-[0.5em] text-white/20 hover:text-white transition-all flex items-center gap-3 group">
          ...
          <button
            ...
            className={cn("relative overflow-hidden btn-editorial btn-editorial-primary !px-14 !py-7 font-sans font-black group shadow-[0_30px_80px_-20px_rgba(212,175,55,0.4)]", !form.category && "opacity-40 grayscale cursor-not-allowed")}
          >
