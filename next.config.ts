    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://maps.googleapis.com https://*.sentry.io; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: https://maps.gstatic.com https://maps.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' http://localhost:3002 https://api.stripe.com http://localhost:3000 https://maps.googleapis.com https://*.sentry.io https://*.ingest.sentry.io; frame-src 'self' https://js.stripe.com https://www.google.com;" },
        ],
      },
    ];
  },
